...
import { Trash2, Upload, Settings, Image as ImageIcon, Save, LogOut } from "lucide-react";
          ...
          <div className="bg-gray-900 px-6 py-8 sm:px-10">
            <div className="flex justify-between items-start">
              ...
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-red-500/10 text-red-500 rounded-lg hover:bg-red-500 hover:text-white transition-colors border border-red-500/20"
              >
